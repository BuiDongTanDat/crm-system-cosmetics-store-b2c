    ...
    <div className="homepage">
      ...
      <section id="billboard" className="bg-light py-5">
        <div className="container">
          ...
          {/* ...existing sections continue with className instead of class, xlinkHref instead of xlink:href, etc... */}
        </div>
      </section>

      {/* ...all other existing sections with JSX syntax... */}
