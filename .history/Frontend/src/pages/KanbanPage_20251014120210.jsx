...
export default function KanbanPage() {
  ...
  <div className="flex flex-col h-full overflow-hidden">
    ...
    {/* Statistics */}
    <div className="grid grid-cols-4 gap-3 px-4 pb-4 flex-shrink-0">
      {/* Thống kê từng ô */}
    ...
    <div
      ref={kanbanBoardRef}
      data-kanban-board
      className="flex-1 flex gap-4 overflow-x-auto overflow-y-hidden px-4 pb-4 scroll-smooth"
      style={{
        scrollbarWidth: 'thin',
