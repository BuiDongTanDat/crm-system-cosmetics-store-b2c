    ...
    try {
      ...
      const processedProducts = rows.map((item, index) => {
        ...
        return {
          ...
          source: item['Nguồn'] || '',
          currentPriceExtra: cleanVal(item['Giá hiện tại_extra']),
