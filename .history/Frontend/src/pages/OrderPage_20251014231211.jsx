                ...
                {Object.entries(stats).map(([status, count]) => {
                    ...
                    return (
                        <div
                            ...
                            className={`animate-fade-in p-4 rounded-xl border  transition cursor-pointer flex items-center gap-4 ${colorClass}
          hover:shadow-md  active:scale-95 duration-200`}
                        >
                            {/* Icon bên trái */}
