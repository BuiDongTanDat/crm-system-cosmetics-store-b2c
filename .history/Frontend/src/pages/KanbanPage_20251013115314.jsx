...
export default function KanbanPage() {
  ...
  // Drag to scroll on column headers
  useEffect(() => {
    const board = kanbanBoardRef.current;
    if (!board) return;
  ...
  return (
    <div className="p-0 h-screen flex flex-col overflow-hidden">
      ...
      {/* Kanban Board - occupies remaining space, horizontal scrollbar sits at bottom of viewport */}
      <div
        ref={kanbanBoardRef}
        data-kanban-board
        className="flex-1 min-h-0 flex gap-4 overflow-x-auto overflow-y-hidden pb-4 scroll-smooth w-full"
