...
function LayoutInner({ children }) {
  ...
  const desktopGap = 20; // Tailwind spacing 5 (px)

  return (
  <div className="relative flex h-screen overflow-hidden bg-transparent text-foreground">
      <AppSidebar />
      <Backdrop />
      <div
      ...
      >
        <AppHeader />
        <div className="p-4 md:p-6 flex-1 w-full mx-auto max-w-screen-2xl">
          {children}
        </div>
      </div>
    </div>
