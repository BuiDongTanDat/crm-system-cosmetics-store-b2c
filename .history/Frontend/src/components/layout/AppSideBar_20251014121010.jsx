...
export function AppSidebar() {
  ...
  return (
    <aside
      ...
      className={`fixed z-30 flex flex-col bg-background border border-border transition-all duration-200 ease-in-out shadow-md ${isExpanded || isMobileOpen || isHovered ? "w-[260px]" : "w-[64px]"
        } ${isMobileOpen ? "translate-x-0" : "-translate-x-full"
        } lg:translate-x-0 ${!isMobile ? "top-3 left-4 rounded-xl" : "top-0 left-0 h-screen border-r"
        }`}
