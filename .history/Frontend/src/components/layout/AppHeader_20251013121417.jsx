        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="actionNormal" aria-label="Notifications">
              ...
              {notifList.some(n => !n.read) && (
                <span className="ml-2 inline-flex items-center justify-center rounded-full bg-red-500 text-white text-xs w-4 h-4">{
          ...
          <DropdownMenuContent className="w-96 p-0 overflow-hidden" align="end" sideOffset={8}>
            <div className="flex items-center justify-between px-4 py-3 border-b">
              ...
              <button className="text-sm text-gray-500 px-2" onClick={() => setNotifList([])}>Xóa tất cả</button>
            </div>
