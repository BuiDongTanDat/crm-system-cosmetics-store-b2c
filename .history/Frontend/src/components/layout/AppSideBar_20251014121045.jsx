...
export function AppSidebar() {
  ...
  return (
    <aside
      ...
      className={`fixed z-0 flex flex-col bg-background border border-border transition-all duration-200 ease-in-out shadow-md ${isExpanded || isMobileOpen || isHovered ? "w-[260px]" : "w-[64px]"
