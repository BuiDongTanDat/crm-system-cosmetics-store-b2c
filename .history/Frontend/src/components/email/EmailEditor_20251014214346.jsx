...
import { Eye, Download, Upload, Smartphone, Monitor, Type, Image, Link, Palette } from 'lucide-react';
    ...
    const templates = {
      welcome: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <h1 style="color: #333; text-align: center; margin-bottom: 20px;">Chào mừng {{customer_name}}!</h1>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="#" style="background: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;">Bắt đầu khám phá</a>
          </div>
          <p style="color: #999; font-size: 12px; text-align: center;">{{company_name}} - {{current_date}}</p>
        </div>
      `,
      newsletter: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <h1 style="color: #333; margin-bottom: 20px;">Bản tin tháng này</h1>
          <p style="color: #666; font-size: 16px;">Xin chào {{customer_name}},</p>
          <p style="color: #666; font-size: 16px; line-height: 1.5;">Đây là những cập nhật mới nhất từ chúng tôi trong tháng này.</p>
          <h2 style="color: #333; margin: 30px 0 15px 0;">Tin tức nổi bật</h2>
          <p style="color: #666; font-size: 16px; line-height: 1.5;">Nội dung tin tức và cập nhật sản phẩm...</p>
          <p style="color: #999; font-size: 12px; text-align: center; margin-top: 40px;">{{company_name}} - {{current_date}}</p>
        </div>
      `,
      promotion: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <h1 style="color: #e74c3c; text-align: center; margin-bottom: 20px;">🔥 Ưu đãi đặc biệt!</h1>
          <p style="color: #666; font-size: 16px;">Xin chào {{customer_name}},</p>
          <p style="color: #666; font-size: 16px; line-height: 1.5;">Đừng bỏ lỡ cơ hội giảm giá lên đến 50% cho tất cả sản phẩm!</p>
          <div style="text-align: center; margin: 30px 0;">
            <a href="#" style="background: #e74c3c; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-size: 18px; display: inline-block;">Mua ngay</a>
          </div>
          <p style="color: #999; font-size: 12px; text-align: center;">{{company_name}} - {{current_date}}</p>
        </div>
      `,
      cart_recovery: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <h1 style="color: #333; margin-bottom: 20px;">Bạn quên gì đó rồi!</h1>
          <p style="color: #666; font-size: 16px;">Xin chào {{customer_name}},</p>
          <p style="color: #666; font-size: 16px; line-height: 1.5;">Có vẻ như bạn đã để lại một số sản phẩm trong giỏ hàng. Đừng để chúng chờ đợi thêm nữa!</p>
          <div style="text-align: center; margin: 30px 0;">
            <a href="#" style="background: #28a745; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;">Hoàn tất đơn hàng</a>
          </div>
          <p style="color: #999; font-size: 12px; text-align: center;">{{company_name}} - {{current_date}}</p>
        </div>
      `
        ...
        <div className="lg:col-span-3">
          {editorMode === 'visual' ? (
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 min-h-[400px] bg-white">
                <div 
                  dangerouslySetInnerHTML={{ __html: localContent.html || '<p style="color: #ccc; text-align: center; padding: 40px;">Chọn template hoặc nhập HTML để bắt đầu thiết kế...</p>' }}
            ...
            <div>
              <textarea
                ...
                className="w-full h-96 p-4 border rounded-lg font-mono text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500"
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              className="w-full h-24 p-3 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500"
