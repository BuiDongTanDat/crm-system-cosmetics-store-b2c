    ...
    <div className="bg-white border-gray-200 overflow-hidden rounded-sm
      ...
      <div className="p-4 border-b">
        <div className="flex items-start justify-between mb-2">
          <h3 className="font-semibold text-gray-900 line-clamp-2 flex-1 cursor-pointer" onClick={() => onView(automation)}>
            {automation.name}
          </h3>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between gap-2">
          {/* Action buttons - luôn hiển thị bên trái */}
          ...
          {/* Status Toggle - luôn hiển thị bên phải */}
          <div className="flex items-center gap-1">
