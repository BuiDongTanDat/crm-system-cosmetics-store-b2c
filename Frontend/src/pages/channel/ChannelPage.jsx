	...
	return (
		...
		<div className="flex flex-col">
			<div className="pt-4 flex-1 min-h-0">
				{/* container: left + right, allow children to control their own overflow */}
				<div className="flex gap-2 px-0 min-h-0 flex-1 flex-col sm:flex-row">
					{/* Left: channels column */}
					<aside className="h-full w-full md:w-64 bg-white rounded-2xl border p-3  flex flex-col min-h-0">
					...
					{/* Right: */}
					<main className="flex-1 flex flex-col gap-2 h-full min-h-0 overflow-auto">
