  ...
  return (
    <div className="p-0">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        <h2 className="text-xl font-semibold mb-2">Customer Frequency Monetary Analysis</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100 shadow-sm transition-all hover:shadow-md">
            <h3 className="font-semibold text-indigo-900 mb-1">Tần suất mua hàng</h3>
            <p className="text-3xl font-bold text-indigo-700">
              {summary ? Number(summary.avg_frequency_90d).toFixed(1) : '...'}
            </p>
            <span className="text-sm text-indigo-600">lần/90 ngày trung bình</span>
          </div>
          <div className="bg-green-50 p-6 rounded-xl border border-green-100 shadow-sm transition-all hover:shadow-md">
            <h3 className="font-semibold text-green-900 mb-1">Giá trị trung bình</h3>
            <p className="text-3xl font-bold text-green-700">
              {summary ? (Number(summary.avg_order_value_90d) / 1000000).toFixed(1) + 'M' : '...'} VNĐ
            </p>
          ...
          <div className="bg-purple-50 p-6 rounded-xl border border-purple-100 shadow-sm transition-all hover:shadow-md">
            <h3 className="font-semibold text-purple-900 mb-1">Customer Score</h3>
            <p className="text-3xl font-bold text-purple-700">
              {summary?.avg_cfm_score ? Number(summary.avg_cfm_score).toFixed(1) + '/10' : '7.5/10'}
            </p>
