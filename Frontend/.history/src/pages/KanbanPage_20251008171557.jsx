...
export default function KanbanPage() {
  ...
  useEffect(() => {
    ...
    if (hasChanged) {
      // Debounce to prevent rapid successive animations
      const timer = setTimeout(() => {
        setShouldAnimateStats(true);
        setPrevStats(stats);
        
        // Reset animation flag after animation completes
        setTimeout(() => setShouldAnimateStats(false), 2000);
      }, 150); // 150ms debounce

      return () => clearTimeout(timer);
    }
  }, [stats, prevStats, isInitialLoad]);
  ...
  return (
    <div className="p-0 h-screen overflow-hidden">
      ...
      {/* Statistics with optimized CountUp */}
            ...
            <div>
              ...
              {shouldAnimateStats ? (
                <CountUp 
                  ...
                  preserveValue
                  key={`total-deals-${stats.totalDeals}`}
                />
              ) : (
            ...
            <div>
              ...
              {shouldAnimateStats ? (
                <CountUp 
                  ...
                  preserveValue
                  key={`total-value-${stats.totalValue}`}
                />
              ) : (
            ...
            <div>
              ...
              {shouldAnimateStats ? (
                <CountUp 
                  ...
                  className="text-lg font-bold text-gray-900"
                  preserveValue
                  key={`conversion-rate-${stats.conversionRate}`}
                />
              ) : (
            ...
            <div>
              ...
              {shouldAnimateStats ? (
                <CountUp 
                  ...
                  className="text-lg font-bold text-gray-900"
                  preserveValue
                  key={`active-deals-${stats.activeDeals}`}
                />
              ) : (
