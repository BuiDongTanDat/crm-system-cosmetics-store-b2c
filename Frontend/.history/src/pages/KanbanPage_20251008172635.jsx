...
export default function KanbanPage() {
  ...
  // Drag to scroll on header area only
  useEffect(() => {
    const board = kanbanBoardRef.current;
  ...
  return (
    <div className="p-0 h-screen overflow-hidden">
      ...
      {/* Drag Header for Board Scrolling */}
      <div 
        ref={boardHeaderRef}
        className="h-8 bg-gray-50 border border-gray-200 rounded-t-lg mb-2 flex items-center justify-center cursor-grab select-none"
      ...
      >
        ...
        <span className="ml-2 text-xs text-gray-500">Kéo để cuộn ngang</span>
      </div>
      ...
      <div
        ...
        style={{ height: 'calc(100vh - 240px)', scrollbarWidth: 'thin', scrollbarColor: '#CBD5E1 #F1F5F9' }}
      >
        {columns.map(column => (
